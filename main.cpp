...
char *StampaCodice(char *codice)
{
    ...
    void menu(){
         ...
         cout<<"1)Lettura anagrafica"<<endl;
         cout<<"2)Modifica anagrafica"<<endl;
         cout<<"3)Calcola Codice Fiscale"<<endl;
         cout<<"4)Esci"<<endl;
        return;
    }
    ...
    void Immisione_dati(char *nome,char *cognome,char *luogo,char *sigla,char* sesso, char* frase)
    {
        ...
        {cout<<"La data di nascita inserita non é corretta, ripetiamo l'inserimento dei dati " <<endl;
        return;
        }
        ...
        cout<<"Nota personale (un motto o qualcosa che descriva l'utente, non usare spazi): "<<endl;
        cin>>frase;
        return;
    }
